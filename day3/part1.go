...
var filePath = flag.String("file", "part1test.txt", "File path to the engine schematic file")
...
func computePartSum(contents string) (int, error) {
...
func main() {
	...
	score, err := computePartSum(string(contents))
	if err != nil {
		log.Fatal(err)
	}
